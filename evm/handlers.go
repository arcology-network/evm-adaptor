...
// func arrayCreateV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
// func arraySizeV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
// func arraySetUint256V2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
// func arrayGetUint256V2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	index := BytesToInt32(input[64:68])
...
// func arraySetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	index := BytesToInt32(input[64:68])
// 	value := input[80:100]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
...
// func arrayGetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	index := BytesToInt32(input[64:68])
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func arraySetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	index := BytesToInt32(input[64:68])
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
// 	value := input[164:]
...
// func arrayGetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	index := BytesToInt32(input[64:68])
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func varCreateV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
// func varSetUint256V2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	value := input[36:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func varGetUint256V2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	idLen := BytesToInt32(input[64:68])
// 	id := string(input[68 : 68+idLen])
...
// func varSetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	value := input[48:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func varGetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	idLen := BytesToInt32(input[64:68])
// 	id := string(input[68 : 68+idLen])
...
// func varSetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
// 	value := input[132:]
// 	if len(value)%32 != 0 {
...
// func varGetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	idLen := BytesToInt32(input[64:68])
// 	id := string(input[68 : 68+idLen])
...
// func hashmapCreateV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
// func hashmapUint256AddressGetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapUint256AddressSetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	value := input[80:100]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
...
// func hashmapUint256Uint256GetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapUint256Uint256SetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	value := input[68:100]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
...
// func hashmapUint256BytesGetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapUint256BytesSetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
// 	value := input[164:]
...
// func hashmapAddressAddressGetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapAddressAddressSetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	value := input[80:100]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
...
// func hashmapAddressUint256GetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapAddressUint256SetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	value := input[68:100]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
...
// func hashmapAddressBytesGetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapAddressBytesSetV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	idLen := BytesToInt32(input[128:132])
// 	id := string(input[132 : 132+idLen])
// 	value := input[164:]
...
// func hashmapDeleteKeyUint256V2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[36:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
// func hashmapDeleteKeyAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
// 	key := input[48:68]
// 	idLen := BytesToInt32(input[96:100])
// 	id := string(input[100 : 100+idLen])
...
func uuidGenV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
func systemCreateDeferV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
...
func systemCallDeferV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
func dynarrayCreateV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	elemType := BytesToInt32(input[64:68])
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
...
func dynarrayLengthV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
...
func dynarrayPushBackAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	elem := input[48:68]
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
...
func dynarrayPushBackBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
...
func dynarrayTryPopFrontAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
...
func dynarrayTryPopFrontBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
...
func dynarrayPopFrontAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
	elem, err := api.dynarray.PopFront(types.Address(hex.EncodeToString(caller.Bytes())), id, clib.DataTypeAddress)
	if err == nil {
...
func dynarrayPopFrontBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
	elem, err := api.dynarray.PopFront(types.Address(hex.EncodeToString(caller.Bytes())), id, clib.DataTypeBytes)
	if err == nil {
...
func dynarrayTryPopBackAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
...
func dynarrayTryPopBackBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
...
func dynarrayPopBackAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
	elem, err := api.dynarray.PopBack(types.Address(hex.EncodeToString(caller.Bytes())), id, clib.DataTypeAddress)
	if err == nil {
...
func dynarrayPopBackBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	idLen := BytesToInt32(input[64:68])
	id := string(input[68 : 68+idLen])
	elem, err := api.dynarray.PopBack(types.Address(hex.EncodeToString(caller.Bytes())), id, clib.DataTypeBytes)
	if err == nil {
...
func dynarrayTryGetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	index := BytesToInt32(input[64:68])
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
...
func dynarrayTryGetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	index := BytesToInt32(input[64:68])
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
...
func dynarrayGetAddressV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	index := BytesToInt32(input[64:68])
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
	elem, err := api.dynarray.Get(types.Address(hex.EncodeToString(caller.Bytes())), id, int(index), clib.DataTypeAddress)
...
func dynarrayGetBytesV2(api *API, caller, callee common.Address, input []byte, origin common.Address, nonce uint64, thash, bhash common.Hash) ([]byte, bool) {
	index := BytesToInt32(input[64:68])
	idLen := BytesToInt32(input[96:100])
	id := string(input[100 : 100+idLen])
	elem, err := api.dynarray.Get(types.Address(hex.EncodeToString(caller.Bytes())), id, int(index), clib.DataTypeBytes)

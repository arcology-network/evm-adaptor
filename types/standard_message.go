...
// 	data = append(data, evmcommon.AlignToEvmForInt(evmcommon.EvmWordSize)...)
// 	idLen := evmcommon.AlignToEvmForInt(len(def.DeferID))
// 	id := evmcommon.AlignToEvmForString(def.DeferID)
...
// 	return this.TxHash == other.TxHash
// }
